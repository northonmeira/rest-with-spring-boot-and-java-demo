...
import br.com.northon.demo.integrationtests.vo.TokenVO;
import br.com.northon.demo.integrationtests.vo.wrappers.WrapperPersonVO;
...
public class PersonControllerJsonTest extends AbstractIntegrationTest {
	...
	public void testFindAll() throws JsonMappingException, JsonProcessingException {
		...
		assertEquals("Alison", foundPersonOne.getFirstName());
		assertEquals("Cantua", foundPersonOne.getLastName());
		assertEquals("45 Raven Terrace", foundPersonOne.getAddress());
